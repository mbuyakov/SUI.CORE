...
import ru.smsoft.sui.suibackend.model.ResponseMessage;
...
public class MessageHandlerService {
    ...
    public @NonNull ResponseMessage processMessage(@NonNull String messagePayload, @NonNull UserState userState) {
