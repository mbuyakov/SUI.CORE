  ...
  private async updateMetaData(): Promise<void> {
    ...
    if (tableInfo) {
      ...
      if (this.props.cardLinkFn) {
        const _cardLinkFnIcon = this.props.cardLinkFnIcon ? this.props.cardLinkFnIcon : <MuiIcons.Link/>;
        let btn = (
          <IconButton
        ...
        if (this.props.cardLinkTooltip) {
          btn = (
            <Tooltip title={this.props.cardLinkTooltip} placement="bottom" mouseEnterDelay={300}>
              {btn}
            </Tooltip>
          );
        }
