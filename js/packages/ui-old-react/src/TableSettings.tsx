                                          ...
                                          return refColInfo
                                            ? (
                                              <Button
                                                size="small"
                                                type="ghost"
                                                onClick={(): void => draw(<StyledEngineProvider injectFirst>
                                                  <ThemeProvider theme={this.props.theme}><FullScreenTableSettings id={refColInfo.tableInfoId} defaultOpen={true}/></ThemeProvider>
...
//TODO restore theme
export const TableSettings = _TableSettings;
