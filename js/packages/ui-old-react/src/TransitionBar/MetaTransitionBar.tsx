...
export interface IMetaTransitionBarProps<TStatus extends ITransitionStatus<TID>, TAction, TResolution, TID extends string | number = string>
...
export class MetaTransitionBar<TStatus extends ITransitionStatus<TID>, TAction = IObjectWithIndex, TResolution = IObjectWithIndex, TID extends string | number = string>
