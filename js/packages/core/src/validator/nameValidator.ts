...
export const LAST_REGEXP_MESSAGE  = "Допустимые символы: А-Я, а-я, 0-9, (), -, ' точка \".\" в Фамилии не допускается, знаки \" - ' ` \" не могут быть последними символома, идти подряд или через пробел";
export const NAME_REGEXP_MESSAGE = "Допустимые символы: А-Я, а-я, 0-9, (), -, ' знаки \" - ' ` \" не могут быть последними символома, идти подряд или через пробел";
