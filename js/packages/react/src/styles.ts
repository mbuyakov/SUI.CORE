...
export const BASE_CARD = "baseCard";
export const BASE_CARD_COLS = "baseCardCols";
export const BASE_CARD_COL_TITLE = "baseCardColTitle";
export const TABLE_NO_DATA_CELL_SMALL = "tableNoDataCellSmall";
export const BASE_CARD_HEADER_ONLY = "baseCardHeaderOnly";
