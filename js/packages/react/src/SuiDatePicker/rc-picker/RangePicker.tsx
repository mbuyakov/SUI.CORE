        ...
        >
          ...
          >
            <input
              ...
              onChange={e => {
                triggerStartTextChange(needToChangeByMask
                  ? changeDateByMask(startHoverValue || startText, e.target.value, formatList[0] as string)
                  : e.target.value);
              }}
              autoFocus={autoFocus}
          ...
          >
            <input
              ...
              onChange={e => {
                triggerEndTextChange(needToChangeByMask
                  ? changeDateByMask(endHoverValue || endText, e.target.value, formatList[0] as string)
                  : e.target.value);
              }}
